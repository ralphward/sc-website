...
if (isset($_REQUEST['email'])) {  
  ...
  $valid_ref1 = "http://www.shimara.com/contact.php";
  $valid_ref2 = "http://shimara.com/contact.php";
  $valid_ref3 = "http://www.shimara.co.uk/contact.php";
  $valid_ref4 = "http://shimara.co.uk/contact.php";
  $valid_ref5 = "http://www.shimara.com.au/contact.php";
  $valid_ref6 = "http://shimara.com.au/contact.php";
  $valid_ref7 = "http://katie-pc/contact.php";
